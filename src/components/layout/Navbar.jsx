...
import { LineChart, Scale, Landmark, Dices, BookOpen, Moon, Sun, TrendingUp } from 'lucide-react'

export const NAV_ITEMS = [
  { id: 'simulateur', label: 'Simulateur', icon: LineChart },
  { id: 'comparateur', label: 'Enveloppes', icon: Scale },
  { id: 'retraite', label: 'Retraite', icon: Landmark },
          ...
          return (
            <button
              ...
              className={`flex flex-1 flex-col items-center gap-0.5 py-2 text-[10px] font-semibold transition ${
                active ? 'text-navy-800 dark:text-white' : 'text-navy-400'
              }`}
            >
